...
class PricingAdjustmentPageSmsPool extends StatefulWidget {
  const PricingAdjustmentPageSmsPool({super.key});

  @override
  _PricingAdjustmentPageSmsPoolState createState() => _PricingAdjustmentPageSmsPoolState();
}

class _PricingAdjustmentPageSmsPoolState extends State<PricingAdjustmentPageSmsPool> {
...
Map<String, int> _parsePriceMap(Map<String, dynamic> data) {
  ...
  Future<void> _updatePrice(
    ...
    try {
      ...
      final countryRef =
          FirebaseFirestore.instance.collection('ggsms_prices_smspool').doc(countryName);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Adjust Price For SmsPool')),
